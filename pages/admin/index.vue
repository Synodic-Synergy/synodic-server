  ...
  <div class="min-h-screen w-full bg-gradient-to-br from-dark-primary via-dark-secondary to-orange-900/20 relative overflow-x-hidden">
      ...
      <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-6">
          ...
          <div class="flex items-center space-x-4">
            <MotionButton color="orange" size="lg" @click="$router.push('/admin/users/new')">
    ...
    <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        <MotionCard class="p-6 bg-gradient-to-br from-blue-500/10 to-blue-600/5 border-blue-500/20">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-text-primary">{{ systemStats.totalUsers }}</p>
            </div>
          </div>
        </MotionCard>
        ...
        <MotionCard class="p-6 bg-gradient-to-br from-green-500/10 to-green-600/5 border-green-500/20">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-text-primary">{{ systemStats.activeCourses }}</p>
            </div>
          </div>
        </MotionCard>
        ...
        <MotionCard class="p-6 bg-gradient-to-br from-yellow-500/10 to-yellow-600/5 border-yellow-500/20">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-text-primary">{{ systemStats.pendingReviews }}</p>
            </div>
          </div>
        </MotionCard>
        ...
        <MotionCard class="p-6 bg-gradient-to-br from-purple-500/10 to-purple-600/5 border-purple-500/20">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-text-secondary">System Health</p>
              <p class="text-2xl font-bold text-text-primary">{{ systemStats.systemHealth }}%</p>
            </div>
          </div>
        </MotionCard>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <MotionCard class="bg-dark-secondary/80 backdrop-blur-lg">
          <div class="px-6 py-4 border-b border-dark-border">
            <h3 class="text-xl font-semibold text-text-primary">System Status</h3>
          </div>
          <div class="p-6">
            <div class="space-y-4">
              ...
              <div class="flex items-center justify-between p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                <div class="flex items-center">
                  ...
                  <div>
                    <p class="text-sm font-medium text-text-primary">API Server</p>
                    <p class="text-xs text-text-secondary">Running</p>
                  </div>
                </div>
                <span class="text-green-400 text-sm font-medium">Online</span>
              </div>
              ...
              <div class="flex items-center justify-between p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                <div class="flex items-center">
                  ...
                  <div>
                    <p class="text-sm font-medium text-text-primary">File Storage</p>
...
const recentActivity = computed(() => {
  ...
  return [
    ...
    },
    {
      ...
      description: 'Advanced Mathematics by Dr. Smith',
