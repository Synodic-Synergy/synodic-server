        ...
        <div class="p-8">
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <button
                @click="$router.push('/teach/assessments')"
                class="mr-4 bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-500 hover:to-gray-600 text-white p-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400"
              >
          ...
          <form @submit.prevent="handleSubmit" class="space-y-8">
            ...
            <div class="flex justify-end gap-4 pt-6">
              ...
              <button
                ...
                class="bg-gradient-to-r from-indigo-500 to-cyan-500 hover:from-indigo-600 hover:to-cyan-600 disabled:opacity-50 disabled:cursor-not-allowed text-white px-8 py-3 rounded-xl font-semibold text-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-400 flex items-center"
              >
